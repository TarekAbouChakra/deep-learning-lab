# This file can be diregarded as it was not given, but I created it in order to print tensorboard results
...
if __name__ == "__main__":
    ...
    plot_tensorboard_events(tags=["avg_reward"], xlabel="Episodes", ylabel="Reward", title="Test Average Reward", smoothing=0.5)
    # plot_tensorboard_events(tags=["Training_loss"], xlabel="Epochs", ylabel="Loss", title="Training Loss", smoothing=0.9)
